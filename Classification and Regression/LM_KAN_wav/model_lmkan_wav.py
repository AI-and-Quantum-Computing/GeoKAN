...
Learned-Metric KAN with Mexican-hat wavelet basis.
Same metric architecture as GeoKAN-NNMetric but explicitly the wavelet PDE variant.
...
class LMKANWaveletLayer(nn.Module):
